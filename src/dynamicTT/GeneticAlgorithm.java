...
public class GeneticAlgorithm {	
	...
	private static ArrayList<Integer>myvalues=new ArrayList<>();
	private static ArrayList<Integer>myiterations=new ArrayList<>();
	...
	public static void selection(ArrayList<TimeTable> timetables) throws IOException{
		...
		//min= timetableIterator.next().	tness();
		int tempo = 0;
...
//			}  
	...
	private static TimeTable Mutation(TimeTable parentTimetable) {		
		...
		// apply repair strategy here! check whether mutant 
	...
	private static void writeToExcelFile() throws IOException{
		...
		FileWriter writer1 = new FileWriter("values.csv");
...
//			i++;			
			writer.append("\n");
//			for(i=0;i<j;i=i+1){
//				//writer.append((i+1).toString());
//				writer.append(""+myvalues.get(i).toString());
//				writer.append("\n");
//			}
			writer.append("\n");
			writer.flush();
	...
	private static void display() {
		...
		int i=0,j=0;
		System.out.println(myiterations);
